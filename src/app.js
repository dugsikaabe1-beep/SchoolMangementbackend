...
import biometricAttendanceRoutes from './routes/biometricAttendanceRoutes.js';
import attendanceRuleRoutes from './routes/attendanceRuleRoutes.js';
...
app.use('/api/v1/backups', backupRoutes);
  ...
  app.use('/api/v1/biometric-attendance', biometricAttendanceRoutes);
  app.use('/api/v1/attendance/rules', attendanceRuleRoutes);
