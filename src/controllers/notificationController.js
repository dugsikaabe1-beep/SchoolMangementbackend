...
/**
 * Register FCM token
 * @route POST /api/v1/notifications/fcm-tokens
 */
...
/**
 * Remove FCM token
 * @route DELETE /api/v1/notifications/fcm-tokens
 */
 ...
 * @route POST /api/v1/notifications/onesignal-player-ids
 */
export const registerOneSignalPlayerId = asyncHandler(async (req, res) => {
 ...
 * @route DELETE /api/v1/notifications/onesignal-player-ids
 */
export const removeOneSignalPlayerId = asyncHandler(async (req, res) => {
  const { playerId, deviceId } = req.body;
